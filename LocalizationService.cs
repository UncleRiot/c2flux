    ...
    public static class LocalizationService
    {
        ...
        private static Dictionary<string, string> CreateGermanTexts()
        {
            return new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Settings.StorageHistoryDetailsHelp"] = "Erfasst nach einem Laufwerksscan einen kompakten NTFS-Datei-Snapshot für die Storage-History-Detailansicht. Dafür wird die MFT einmal zusätzlich gelesen. Auf sehr großen Laufwerken kann sich der Scanabschluss dadurch verlängern.",
                ...
                ["StorageHistory.Details.Title"] = "Storage History Details",
        ...
        private static Dictionary<string, string> CreateEnglishTexts()
        {
            return new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["Toolbar.StorageHistoryButton"] = "Storage History",
